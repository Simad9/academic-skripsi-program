...
"""
Metrik-metrik untuk mengukur Community detection unsupervised.
Hanya memerlukan matriks prediksi dan matrik ketetanggan (adjacency matrix).

Metriks yang dipakai : 
1. Clustering Coefficient
Tujuan: Mengukur tingkat di mana node dalam suatu komunitas cenderung membentuk kluster (segitiga). Komunitas yang baik harus memiliki koefisien klustering yang tinggi.
Kriteria: Lebih Tinggi lebih baik

2. Coverage
Tujuan: Mengukur persentase tepi (edges) di seluruh graf yang "dijelaskan" oleh setidaknya satu komunitas.
Kriteria: Lebih Tinggi lebih baik

3. Density
Tujuan: Mengukur kepadatan rata-rata dari komunitas yang terdeteksi, di mana kepadatan setiap komunitas dihitung sebagai jumlah tepi yang ada dibagi jumlah tepi yang mungkin.
Kriteria: Lebih Tinggi lebih baik

4. Conductance
Tujuan: Mengukur seberapa terisolasi komunitas dari sisa graf. Komunitas yang baik memiliki conductance rendah karena sedikit tepi keluar.
Kriteria: Lebih rendah lebih baik
"""
