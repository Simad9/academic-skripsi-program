...
Dataset memiliki "ground truth" atau label community.

Metriks yang dipakai : 
1. Symmetric Jaccard Similarity
Tugas : Menghitung kesamaan antara dua penugasan komunitas ($F_1$ dan $F_2$) berdasarkan Symmetric Jaccard Similarity.
2. Overlapping Normalized Mutual Information (NMI)
Tugas : Untuk mengatasi kekurangan metrik Jaccard/F1 yang dapat memberikan skor tinggi secara keliru meskipun komunitas yang diprediksi tidak informatif
"""
