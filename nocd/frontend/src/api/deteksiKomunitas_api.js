...
export async function fetchPilihDatasetData(formData) {
  try {
    ...
    console.error("Error fetching data with Axios:", errorMessage);
...
export async function fetchInputModelData(formData) {
  const url = "/input-model"; // Endpoint untuk mendapatkan data gambar STRINGDB
...
export async function fetchDeteksiKomunitasData(formData) {
  const url = "/deteksi-komunitas"; // Endpoint untuk mendapatkan data gambar STRINGDB
